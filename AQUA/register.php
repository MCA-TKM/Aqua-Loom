  ...
  <div class="limiter">
    ...
    <form action="" method="post" id="add-new-p">
      ...
      <tr>
       ...
       <td><select name="taluk" id="taluk" style=" height: 50px; width: 150px;">
         <option value="">Select District first</option></td>
		   ...
		   <tr>
		    ...
		    <td><select name="Panchayat" style=" height: 50px; width: 150px;">
			<option value="MAYYANAD">MAYYANAD</option>
			<option value="KOTTARAKARA">KOTTARAKARA</option></select></td>
		  </tr>
	 
		  <tr>
		    <td><label for="CATEGORY">CATEGORY :</label></td>
		    <td><select name="Category" style=" height: 50px; width: 150px;">
			...
			<td><input type="text" style=" height: 50px; width: 150px;" name="Others" id="Others" /></td>
