...
<body>
  ...
  <div class="limiter">
    ...
    <form id="add-new-se"action="" method="post">
      ...
      <tr>
        ...
        <td><select name="ce" id="ce">
         <option value="">Select MD first</option>
         <option value="">Select MD </option></td>
       ...
       <tr>
        ...
        <td><input type="text" name="se" id="se" placeholder="Enter Office Name:"></td>
      </tr>
      <tr>
